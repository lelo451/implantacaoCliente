...
begin
  if FSSHClient.IsEmpty then FSSHClient := 'C:\Users\Archer\Documents\Embarcadero\Studio\Projects\Implantacao\Server\scp.exe';
  FSource := ASource;
...
begin
  if FSSHClient.IsEmpty then FSSHClient := 'C:\Users\Archer\Documents\Embarcadero\Studio\Projects\Implantacao\Server\ssh.exe';
  FCommand := ACommand;
