  ...
  try
    ...
    begin
      ...
      try
        ...
        if not FileExists('C:\Program Files\SIN - Sistema de Implantação na Nuvem\projeto\prServerSIGEPS.zip') then
          CriarPasta.DownloadFile('http://www.vipsistemas.com.br/Version/2.5.26.99/prServerSIGEPS2.zip','C:\Program Files\SIN - Sistema de Implantação na Nuvem\projeto\prServerSIGEPS.zip');
        CriarPasta.Descompactar('C:\Program Files\SIN - Sistema de Implantação na Nuvem\projeto\prServerSIGEPS.zip',CaminhoPasta);
